...
<head>
    ...
    <style type="text/css">
        *{margin: 0;padding: 0;}
        ...
        .content{background-color: #f5f5f5;font-size: 1.2rem;height:100%;}
    ...
    <div id="payDiv">
        <table border="1" cellspacing="" cellpadding="" class="key1">
            ...
            <tr>
                ...
                <td class="key6 top" rowspan="3" style="opacity: 0.5;" onclick="nowPay()">立即支付</td>
            </tr>
            <tr>
