...
$pay_memberid = "10039";   //商户ID
$pay_orderid = 'E'.date("YmdHis").rand(100000,999999);    //订单号
$pay_amount = "0.01";    //交易金额
$pay_applydate = date("Y-m-d H:i:s");  //订单时间
$pay_notifyurl = "http://www.xhd9.com/trade/paytest/server.php";   //服务端返回地址
$pay_callbackurl = "http://www.xhd9.com/trade/paytest/page.php";  //页面跳转返回地址
$Md5key = "37s7m9enckk5ew8mhpx47zzqryws9zgd";   //密钥
$tjurl = "http://feng.langlitaosha.com//Pay_Index.html";   //提交地址
