define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'pay/system/index',
                    add_url: 'pay/system/add',
                    edit_url: 'pay/system/edit',
                    del_url: 'pay/system/del',
                    multi_url: 'pay/system/multi',
                    table: 'pay_config',
                }
            });
            ...
            $(document).on("click", ".testmail", function () {
                ...
                Layer.prompt({title: __('Please input your email'), formType: 0}, function (value, index) {
                    Backend.api.ajax({
                        url: "pay/system/emailtest?receiver=" + value,
            ...
            $(document).on("click", ".btn-delcfg", function () {
                ...
                Layer.confirm(__('Are you sure you want to delete this item?'), {icon: 3, title:'提示'}, function (index) {
                    Backend.api.ajax({
                        url: "pay/system/del?receiver=" + value,
