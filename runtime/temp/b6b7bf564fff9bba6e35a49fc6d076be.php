<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\phpstudy_pro\WWW\18pay\public/../application/admin\view\pay\system\index.html";i:1554192232;s:68:"D:\phpstudy_pro\WWW\18pay\application\admin\view\layout\default.html";i:1547349022;s:65:"D:\phpstudy_pro\WWW\18pay\application\admin\view\common\meta.html";i:1553246434;s:67:"D:\phpstudy_pro\WWW\18pay\application\admin\view\common\script.html";i:1547349022;}*/ ?>
<!DOCTYPE html>
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane fade <?php echo !empty($vo['active'])?'active in' : ''; ?>" id="<?php echo $vo['name']; ?>">
                <div class="widget-body no-padding">
                    <form id="<?php echo $vo['name']; ?>-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('pay.system/edit'); ?>">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "{\$payment.". $item['name'] . "}"; ?></td>
            ...
            <div class="tab-pane fade" id="addcfg">
                <form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('pay.system/add'); ?>">
